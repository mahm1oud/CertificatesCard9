 ...
 * 
 * النسخة: 2.0 - تاريخ التحديث: 2025-05-04
 * تحسينات الإصدار 2.0:
 * - إضافة إعدادات تتبع الأخطاء والتشخيص
 * - تحسين إعدادات اتصال قاعدة البيانات
 * - إضافة خيارات متقدمة لمعالجة الجلسات
 * - دعم الصور وحفظها
 */
...
module.exports = {
  ...
  database: {
    ...
    name: process.env.DB_NAME || 'u240955251_colliderdb',
    // إعدادات إضافية للاتصال
    connectionLimit: parseInt(process.env.MYSQL_CONNECTION_LIMIT || '10'),
    connectTimeout: parseInt(process.env.MYSQL_CONNECT_TIMEOUT || '10000'), // 10 ثوان
    waitForConnections: true,
    queueLimit: 0,
    // تحسينات الاتصال
    enableKeepAlive: true,
    keepAliveInitialDelay: 30000, // 30 ثانية
    // إعدادات إعادة المحاولة
    retryAttempts: parseInt(process.env.MYSQL_RETRY_ATTEMPTS || '5'),
    retryDelay: parseInt(process.env.MYSQL_RETRY_DELAY || '2000'), // 2 ثانية
